...
- [x] active_account_resolved
- [x] configured_account_matches_session
- [x] lightstreamer_endpoint_available
- [x] market_details_retrieved
- [x] market_tradeable
...
- [ ] dry_run_order_valid
- [x] dry_run_order_not_sent
- [x] max_open_positions_one
- [x] risk_per_trade_set
