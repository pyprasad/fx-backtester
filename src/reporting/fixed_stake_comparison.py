...
def write_fixed_stake_comparison(
    ...
    result = {
        ...
        "baseline_worst_trade_r": float(baseline_summary["worst_trade_r"]),
        "fixed_stake_worst_trade_r": float(fixed_summary["worst_trade_r"]),
        "baseline_worst_trade_pips": min((_baseline_pips(row) for row in baseline), default=0),
        "fixed_stake_worst_trade_pips": min((float(row["pnl_pips"]) for row in fixed), default=0),
